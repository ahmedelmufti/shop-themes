!(function(e) {
  ...
  function(e, t, n) {
    ...
    var ge,
      ...
      Te = n(2),
      Re = n.n(Te),
      je = window.Promise ? Promise : Re.a,
      Ie = je,
      Me =
        Object.assign ||
        function(e) {
      ...
      De = function(e) {
        return (
          e &&
          'object' === (void 0 === e ? 'undefined' : qe(e)) &&
            ...
            r.forEach(function(n) {
              n &&
                Object.keys(n).forEach(function(r) {
                  var o = i[r],
                    a = n[r],
                    s = De(o) && !(t && Array.isArray(o));
                  'object' === (void 0 === a ? 'undefined' : qe(a)) && s
                    ? (i[r] = e(t)(o, Be(a)))
                    : void 0 !== a
                    ? (i[r] = De(a) ? e(t)(a) : Be(a))
                    : void 0 !== o && (i[r] = o);
      ...
      Ge = Object.keys(Ye),
      Ve = { live: 'live', test: 'test', unknown: 'unknown' },
      Ke = function(e) {
      ...
      at = function(e) {
        return function(t, n) {
          return 'string' == typeof t && 0 === t.indexOf(e)
            ? Xe(t)
            : nt('a string starting with ' + e, t, n);
        };
      },
      st = function() {
      ...
      ut = st.apply(void 0, s(Ge)),
      lt = st.apply(void 0, s(He)),
      pt = (st.apply(void 0, s(Object.keys(Ve))),
      function(e, t) {
        return 'string' == typeof e ? Xe(e) : nt('a string', e, t);
      }),
      dt = function(e, t) {
        return function(n, r) {
          return void 0 === n ? Xe(t()) : e(n, r);
        };
      },
      ft = function(e, t) {
        return 'boolean' == typeof e ? Xe(e) : nt('a boolean', e, t);
      },
      ht = function(e, t) {
        return 'number' == typeof e ? Xe(e) : nt('a number', e, t);
      },
      _t = function(e) {
        return function(t, n) {
          return 'number' == typeof t && t > e
            ? Xe(t)
            : nt('a number greater than ' + e, t, n);
        };
      },
      mt = function(e) {
        return function(t, n) {
          ...
          if (Array.isArray(t)) {
            return t
              .map(function(t, r) {
                return e(
                  t,
                  Je({}, n, { path: [].concat(s(n.path), [String(r)]) })
                );
              })
              .reduce(function(e, t) {
                return 'error' === e.type
        ...
        return function(t) {
          return function(n, r) {
            if (
              ...
              return (
                i &&
                  (c = Object.keys(o).reduce(function(e, n) {
                    return t[n]
                      ? e
                      : Xe(
                          e.value,
                ...
                Object.keys(t).reduce(function(e, n) {
                  ...
                  var i = t[n],
                    c = i(o[n], Je({}, r, { path: [].concat(s(r.path), [n]) }));
                  return 'valid' === c.type && void 0 !== c.value
                    ? Xe(
                        Je({}, e.value, a({}, n, c.value)),
                        [].concat(s(e.warnings), s(c.warnings))
                      )
                    : 'valid' === c.type
                    ? Xe(e.value, [].concat(s(e.warnings), s(c.warnings)))
                    : c;
                }, c)
              );
            }
            return nt('an object', n, r);
          };
        };
      },
      Ot = kt(!0),
      ...
      St = function(e, t, n, r) {
        ...
        return 'valid' === i.type
          ...
          : {
              type: 'error',
              errorType: 'full',
              error: new Ae(Ze(i.expected, i.actual, i.options))
            };
      },
      At = function(e, t, n, r) {
        var o = St(e, t, n, r);
      ...
      Nt = function(e) {
        switch (e) {
          ...
          case 'CONTROLLER':
            return Lt('controller-3750e20eb7811c174a4e9d27ed010f69.html');
          case 'METRICS_CONTROLLER':
            return 'https://js.stripe.com/v2/m/outer.html';
          case 'PAYMENT_REQUEST_ELEMENT':
            return Lt(
              'elements-inner-payment-request-5a84a4a415f8132fc95d06424e0a80c0.html'
            );
          case 'PAYMENT_REQUEST_BROWSER':
            return Lt(
              'payment-request-inner-browser-d3c16607f107a9b255d6feb42346f544.html'
            );
          case 'PAYMENT_REQUEST_GOOGLE_PAY':
            return Lt(
              'payment-request-inner-google-pay-51e4c698cfb0c5c41d7f38ae19058c6e.html'
            );
          case 'IBAN_ELEMENT':
            return Lt(
              'elements-inner-iban-7ce5666d466542d54922f6742b786f34.html'
            );
          case 'IDEAL_BANK_ELEMENT':
            return Lt(
              'elements-inner-ideal-bank-436f41a5db88673ff884c52960d3959e.html'
            );
          case 'AUTHORIZE_WITH_URL':
            return Lt(
              'authorize-with-url-inner-0f5d441d72580a888af7a38ae6071ebe.html'
            );
          case 'CARDINAL_3DS2':
            return Lt('cardinal-inner-25f82d9ba3673fd26c3f05194855f1c3.html');
          case 'STRIPE_3DS2':
            return Lt('three-ds-2-inner-7f8c018945abf73f38f998c4b64176bb.html');
          default:
            return Ce(e);
        }
      },
      ...
      xt = Bt,
      Ft = [xt.card, xt.cardNumber, xt.cardExpiry, xt.cardCvc, xt.postalCode],
      Ut = Ft,
      zt = Rt('https://js.stripe.com/v3/'),
      Wt = zt ? zt.origin : '',
      Ht = {
        family: 'font-family',
        src: 'src',
      ...
      Yt = Object.keys(Ht).reduce(function(e, t) {
        return (e[Ht[t]] = t), e;
      }, {}),
      Gt = [xt.idealBank, xt.idealBankSecondary],
      Vt = 0,
      Kt = function(e) {
        return '' + e + Vt++;
      },
      ...
      Qt = function e(t, n) {
        ...
        return (
          Object.keys(t).forEach(function(o) {
            var i = t[o],
              a = n ? n + '[' + o + ']' : o;
            if (i && 'object' === (void 0 === i ? 'undefined' : Jt(i))) {
              var s = e(i, a);
              '' !== s && (r = [].concat(c(r), [s]));
      ...
      cn = function(e) {
        ...
        'controller' === r
          ...
          i &&
            i.postMessage(JSON.stringify(sn({}, e, { __stripeJsV3: !0 })), o);
      },
      un = function(e) {
        try {
      ...
      pn = function(e, t) {
        return function(n) {
          try {
            ...
            return ln(e, t || (this && this._controller));
          }
        };
      },
      dn = function(e, t) {
      ...
      _n = function e() {
        ...
        u(this, e),
          ...
          (this._callbacks = {});
        var n = dn(this._userOn),
          r = dn(this._off),
          o = dn(this._once),
          i = pn(this._hasRegisteredListener),
          a = pn(this._removeAllListeners),
          s = hn(this._emit);
          ...
          vn(t, [
            {
              key: '_generateId',
              value: function() {
                return Kt('__privateStripeFrame');
              }
            },
            {
              key: 'send',
      ...
      Un = xn({}, Fn, { background: 'rgba(0,0,0,0.5)' }),
      zn = function e(t) {
        var n = this,
          r = t.lockScrolling,
          o = t.lockFocus,
        ...
        k(this, e),
          ...
          (this.show = function() {
            if ((rn(n.domElement, Fn), n._lockScrolling)) {
              var e = Nn();
              n._runOnHide.push(e);
            }
            if (n._lockFocus) {
              var t = Bn(n._lockFocusOn);
              n._runOnHide.push(t);
            }
          }),
      ...
      Gn = (function(e) {
        function t(e, n, r) {
          ...
          return (
            ...
            (o.show = function() {
              o._backdrop.show(), rn(o._iframe, Yn);
            }),
            (o.fadeInBackdrop = function() {
              o._backdrop.fadeIn();
            }),
            (o.destroy = function() {
              return o._backdrop.fadeOut().then(function() {
                o._backdrop.unmount(),
                  Hn(
                    t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                    'destroy',
          ...
          $n(t, [
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return rn(n, Qn), (n.style.height = '0'), n;
              }
            }
          ]),
          t
      ...
      nr = function(e) {
        return tr(e, 'https://js.stripe.com/v3/');
      },
      rr = function(e) {
        return nr(e) || er(e);
      },
      ...
      pr(dr),
      (function(e) {
        /Android 4\./i.test(e) && !/Chrome/i.test(e) && pr(e);
      })(dr),
      (function(e) {
      ...
      (function(e) {
        return /AppleWebKit/i.test(e) && !/Chrome/i.test(e) && !sr(e) && !cr(e);
      })(dr)),
      gr = (function(e) {
        return /Chrome/i.test(e) && !sr(e);
      })(dr),
      wr = ((ge = {}),
      R(ge, xt.card, {
        unique: !0,
        conflict: [xt.cardNumber, xt.cardExpiry, xt.cardCvc, xt.postalCode],
        beta: !1
      }),
      R(ge, xt.cardNumber, { unique: !0, conflict: [xt.card], beta: !1 }),
      R(ge, xt.cardExpiry, { unique: !0, conflict: [xt.card], beta: !1 }),
      R(ge, xt.cardCvc, { unique: !0, conflict: [xt.card], beta: !1 }),
      R(ge, xt.postalCode, { unique: !0, conflict: [xt.card], beta: !1 }),
      R(ge, xt.paymentRequestButton, { unique: !0, conflict: [], beta: !1 }),
      R(ge, xt.iban, { unique: !0, conflict: [], beta: !1 }),
      R(ge, xt.idealBank, { unique: !0, conflict: [], beta: !1 }),
      ge),
      Er = wr,
      kr = ((we = {}),
      j(we, xt.card, qt.CARD_ELEMENT),
      j(we, xt.cardNumber, qt.CARD_ELEMENT),
      j(we, xt.cardExpiry, qt.CARD_ELEMENT),
      j(we, xt.cardCvc, qt.CARD_ELEMENT),
      j(we, xt.postalCode, qt.CARD_ELEMENT),
      j(we, xt.paymentRequestButton, qt.PAYMENT_REQUEST_ELEMENT),
      j(we, xt.iban, qt.IBAN_ELEMENT),
      j(we, xt.idealBank, qt.IDEAL_BANK_ELEMENT),
      we),
      Or = kr,
      Pr = ['brand'],
      Sr = ['country', 'bankName'],
      Ar = ((Ee = {}),
      I(Ee, xt.card, Pr),
      I(Ee, xt.cardNumber, Pr),
      I(Ee, xt.iban, Sr),
      Ee),
      Cr = I({}, xt.idealBank, { secondary: xt.idealBankSecondary }),
      Tr =
        'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
          ? function(e) {
              return typeof e;
      ...
      Mr = function e(t) {
        q(this, e), qr.call(this);
        var n = t.apiKey,
          r = t.stripeAccount,
          o = t.stripeJsId,
          i = t.locale;
        (this._id = Kt('__privateStripeController')),
          (this._stripeJsId = o),
          (this._apiKey = n),
          (this._stripeAccount = r),
          (this._controllerFrame = new Cn(qt.CONTROLLER, this._id, Rr({}, t))),
          (this._frames = {}),
          (this._requests = {}),
          this._setupPostMessage(),
          (this._handleMessage = pn(this._handleMessage, this)),
      ...
      qr = function() {
        ...
        (this._sendCAReq = function(t) {
          ...
          (this.createElementFrame = function(t, n) {
            var r = n.groupId,
              o = M(n, ['groupId']),
              i = new Mn(t, e._id, Rr({}, o, { keyMode: Ke(e._apiKey) }));
            ...
            if (n === e._id)
              switch (o.action) {
                ...
                case 'stripe-frame-error':
                  throw new Ae(o.payload.message);
        ...
        return new Ie(function(n, r) {
          var o = t.method,
            ...
            u =
              ...
              (jt(i) && void 0 === new XMLHttpRequest().withCredentials),
            l = 'GET' === o && c ? i + '?' + c : i,
            p = 'GET' === o ? '' : c;
          if (u) {
      ...
      Gr = function(e, t) {
        var n = /@font-face[ ]?{[^}]*}/g,
          r = e.match(n);
        if (!r) throw new Ae('No @font-face rules found in file from ' + t);
        return r;
      },
      Vr = function(e) {
      ...
      Jr = function(e, t) {
        ...
        return (
          ['family', 'src'].forEach(function(e) {
            if (!n[e])
              throw new Ae(
                'Missing css property in file from ' + t + ': "' + Ht[e] + '"'
              );
          }),
          n
        );
      ...
      no = { CAN_MAKE_PAYMENT: 'CAN_MAKE_PAYMENT' },
      ro = {
        success: 'success',
        fail: 'fail',
      ...
      io = { shipping: 'shipping', delivery: 'delivery', pickup: 'pickup' },
      ao = to({ success: 'success' }, oo),
      so = { merchantCapabilities: ['supports3DS'], displayItems: [] },
      co = Pt({ amount: vt, label: pt, pending: rt(ft) }),
      uo = Pt({ amount: yt, label: pt, pending: rt(ft) }),
      lo = Pt({
        amount: yt,
        label: pt,
        pending: rt(ft),
        id: dt(pt, function() {
          return Kt('shippingOption');
        }),
        detail: dt(pt, function() {
          return '';
        })
      }),
      po = st.apply(void 0, x(Object.keys(io))),
      fo = Pt({ origin: pt, name: pt }),
      ho = Pt({
        displayItems: rt(gt(uo)),
        shippingOptions: rt(wt('id')(gt(lo))),
        total: co,
        requestShipping: rt(ft),
        requestPayerName: rt(ft),
        requestPayerEmail: rt(ft),
        requestPayerPhone: rt(ft),
        shippingType: rt(po),
        currency: lt,
        country: ut,
        jcbEnabled: rt(ft),
        __billingDetailsEmailOverride: rt(pt),
        __minApplePayVersion: rt(ht),
        __merchantDetails: rt(fo),
        __skipGooglePayInPaymentRequest: rt(ft)
      }),
      _o = Ot({
        currency: rt(lt),
        displayItems: rt(gt(uo)),
      ...
      mo = function(e, t) {
        ...
        return st.apply(void 0, x(Object.keys(ro)))(
          n.includes(e) ? 'fail' : e,
          t
        );
      },
      ...
      vo = st.apply(void 0, x(Object.keys(ao))),
      bo = {
      ...
      Eo = function(e) {
        var t = wo(e, bo.google_pay_beta_1);
        return yr
          ? t
      ...
      Ao = function(e, t, n, r, o) {
        var i =
            arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : Po,
          a = Math.max(Po, i);
        if (window.ApplePaySession) {
          if (Oo()) {
            ...
            if (window.ApplePaySession.supportsVersion(a)) {
              var s = t ? [e, t] : [e],
                c = 'merchant.' + s.join('.') + '.stripe';
              return So(c).then(function(i) {
                if (
                  (r('pr.apple_pay.can_make_payment_native_response', {
                    available: i
                  }),
                  o('payreq.can_make_payment_native_response', {
                    available: i
                  }),
                  n && !i && window.console)
                ) {
      ...
      Ro = function(e, t) {
        ...
        return -1 !== To.indexOf(e) ? ['amex'].concat(F(n)) : n;
      },
      jo = function(e, t) {
        return Ro(e, t).reduce(function(e, t) {
          return 'mastercard' === t
      ...
      U(ke, ao.success, 0),
      U(ke, ao.fail, 1),
      U(ke, ao.invalid_payer_name, 2),
      U(ke, ao.invalid_shipping_address, 3),
      U(ke, ao.invalid_payer_phone, 4),
      U(ke, ao.invalid_payer_email, 4),
      ke),
      Fo = ((Oe = {}),
      U(Oe, io.pickup, 'storePickup'),
      U(Oe, io.shipping, 'shipping'),
      U(Oe, io.delivery, 'delivery'),
      Oe),
      Uo = {
        total: function(e) {
          return No(e.total, e);
      ...
      zo = {
        shippingType: function(e) {
          ...
          throw new Ae('Invalid value for shippingType: ' + t);
        },
        ...
        supportedNetworks: function(e) {
          return jo(e.country, e.jcbEnabled || !1);
        }
      },
      Wo = {
        status: function(e) {
      ...
      ci = (function(e) {
        function t(e) {
          H(this, t);
          var n = Y(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
          ui.call(n);
          var r = e.controller,
            o = e.authentication,
            i = e.mids,
          ...
          (n._controller = r),
            ...
            (n._authentication = o),
            (n._mids = i),
            (n._minimumVersion = s || Po),
            n._legacyReport('payreq.options', { options: a });
          var c = At(ho, a || {}, 'paymentRequest()'),
            u = c.value;
          if (
            (c.warnings.forEach(function(e) {
              return n._warn(e);
            }),
            u.__billingDetailsEmailOverride && u.requestPayerEmail)
          )
            throw new Ae(
          ...
          ai(t, [
            {
              ...
              value: function() {
                (this._paymentRequestOptions = ii(
                  {},
                  so,
            ...
            },
            {
              ...
              value: function(e, t) {
                ...
                e.addEventListener(
                  'validatemerchant',
                  pn(this._validateMerchant(e, t))
                ),
                  e.addEventListener(
                    'paymentauthorized',
                    pn(this._paymentAuthorized(e))
                  ),
                  e.addEventListener(
                    'cancel',
                    pn(function() {
                      if (
                        (n._legacyReport('payreq.show_rejected'),
                        (n._isShowing = !1),
                        n._onEvent)
                      ) {
                        var e = n._onEvent;
                        e({ type: 'cancel' }), e({ type: 'close' });
                      } else n._emit('cancel');
                    })
                  ),
                  e.addEventListener(
                    'shippingcontactselected',
                    pn(this._shippingContactSelected(e))
                  ),
                  e.addEventListener(
                    'shippingmethodselected',
                    pn(this._shippingMethodSelected(e))
                  );
              }
            }
          ]),
      ...
      ui = function() {
        ...
        (this._onEvent = null),
          ...
          (this.canMakePayment = pn(function() {
            return null === e._cachedCanMakePayment
              ? Ao(
                  window.location.hostname,
                  e._authentication.accountId,
                  Ke(e._authentication.apiKey) === Ve.test,
                  e._report,
                  e._legacyReport,
                  e._minimumVersion
                ).then(function(t) {
                  return (
                    ...
                    e._legacyReport('payreq.can_make_payment_response', {
          ...
          (this.update = pn(function(t) {
            if (e._isShowing)
              throw new Ae(
                'You cannot update Payment Request options while the payment sheet is showing.'
              );
            var n = At(_o, t, 'PaymentRequest update()'),
              r = n.value;
            n.warnings.forEach(function(t) {
              return e._warn(t);
            }),
              (e._initialPaymentRequest = Fe(e._paymentRequestOptions, r)),
              e._initializeSessionState(),
              e._legacyReport('payreq.update', { updates: t });
          })),
          (this.show = pn(function() {
            ...
            if (
              (e._usedByButtonElement &&
                ...
                (e._legacyReport('payreq.show_called_with_button'),
                e._warn(
            ...
            if (!e._cachedCanMakePayment)
              throw new Ae('Payment Request is not available in this browser.');
            e._initializeSessionState();
            var n = void 0;
            try {
              n = new window.ApplePaySession(
                e._minimumVersion,
                Go(e._paymentRequestOptions)
              );
            } catch (e) {
            ...
            (e._privateSession = n),
              ...
              n.begin(),
              (e._isShowing = !0),
              e._legacyReport('payreq.show', {
                listeners: Object.keys(e._callbacks).sort()
              });
          })),
          (this.abort = pn(function() {
            e._privateSession &&
              (e._privateSession.abort(), e._legacyReport('payreq.abort'));
          })),
          ...
          (this._legacyReport = function(t, n) {
            e._controller.report(
              t,
              ii(
                {},
          ...
          (this._handleValidationError = function(t) {
            return function(n) {
              e._report('error.pr.apple_pay.session_creation_failed', {
                error: n
              }),
                t.abort();
              var r = n.message;
              'string' == typeof r
                ? (e._warn(r),
                  e._legacyReport('user_error.apple_pay_session_error', {
                    error: n
                  }))
                : e._legacyReport('fatal.payreq.unexpected_error', {
                    error: n
                  });
            };
          }),
          (this._paymentAuthorized = function(t) {
            return function(n) {
              var r = n.payment;
              e._legacyReport('payreq.paymentauthorized');
              var o = e._showCalledByButtonElement
                ? xt.paymentRequestButton
                : null;
              e._controller.action
                .tokenizeWithData({
                  type: 'apple_pay',
                ...
                .then(function(n) {
                  if ('error' === n.type)
                    t.completePayment(window.ApplePaySession.STATUS_FAILURE),
                      e._legacyReport('payreq.api_error.create_token', {
                        error: n.error
                      });
                  else {
            ...
            if (
              ...
              return (
                t.countryCode
                  ...
                  : (r = si[n]) ||
                    e._legacyReport('warn.payreq.missing_country_code', {
                      country: t.country
                    }),
                ii({}, t, { countryCode: r })
              );
            }
            return 'object' === (void 0 === t ? 'undefined' : oi(t)) ? t : null;
          }),
          (this._onToken = function(t) {
            return function(n) {
              if (e._isShowing && e._onEvent) {
                return void (0, e._onEvent)({
                  type: 'paymentresponse',
                  payload: ii({}, n, { complete: e._completePayment(t) })
                });
              }
              e._hasRegisteredListener('token') &&
                e._maybeEmitSourceOrToken(
                  'token',
                  ii({}, n, { complete: e._completePayment(t) })
                );
              var r = n.token,
                o = W(n, ['token']),
                i = o.payerPhone,
              ...
              e._hasRegisteredListener('source') &&
                e._controller.action
                  ...
                  .then(function(n) {
                    'error' === n.type
                      ? (e._legacyReport('fatal.payreq.source_failed', {
                          error: n.error,
                          token: r
                        }),
                        t.completePayment(
                ...
                e._hasRegisteredListener('paymentmethod') &&
                  e._controller.action
                    ...
                    .then(function(n) {
                      'error' === n.type
                        ? (e._legacyReport('fatal.payreq.pm_failed', {
                            error: n.error,
                            token: r
                          }),
                          t.completePayment(
          ...
          (this._completePayment = function(t) {
            return function(n) {
              var r = At(vo, n, 'status for PaymentRequest completion'),
                o = r.value;
              r.warnings.forEach(function(t) {
                return e._warn(t);
              }),
                (e._paymentRequestOptions = Fe(e._paymentRequestOptions, {
                  status: o
                }));
              ...
              t.completePayment(a),
                -1 ===
                  ...
                  ((e._isShowing = !1),
                  e._onEvent && e._onEvent({ type: 'close' }));
            };
          }),
          (this._shippingContactSelected = function(t) {
            return function(n) {
              ...
              if (
                e._hasRegisteredListener('shippingaddresschange') ||
                e._onEvent
              ) {
                var o = {
                  shippingAddress: r,
                ...
                e._onEvent
                  ? e._onEvent({ type: 'shippingaddresschange', payload: o })
                  : e._emit('shippingaddresschange', o);
              } else {
                ri(e._paymentRequestOptions.shippingOptions);
                var i = Vo(e._paymentRequestOptions),
                  a = i.total,
                  s = i.lineItems,
                  c = i.shippingMethods;
          ...
          (this._completeShippingContactSelection = function(t) {
            return function(n) {
              var r = At(yo, n || {}, 'shipping address selection callback'),
                o = r.value;
              if (
                (r.warnings.forEach(function(t) {
                  return e._warn(t);
                }),
                (e._paymentRequestOptions = Fe(e._paymentRequestOptions, o)),
                e._paymentRequestOptions.status === ao.success)
              ) {
                var i = ri(e._paymentRequestOptions.shippingOptions);
          ...
          (this._shippingMethodSelected = function(t) {
            return function(n) {
              if (
                ...
                e._onEvent
                  ? e._onEvent({ type: 'shippingoptionchange', payload: r })
          ...
          (this._completeShippingMethodSelection = function(t) {
            return function(n) {
              var r = At(yo, n || {}, 'shipping option selection callback'),
                o = r.value;
              r.warnings.forEach(function(t) {
                return e._warn(t);
              }),
              ...
              var i = Vo(e._paymentRequestOptions),
                ...
                s = i.total,
                c = i.lineItems;
              t.completeShippingMethodSelection(a, s, c);
            };
          });
      },
      li = ci,
      ...
      hi = function() {
        return 'https:' === window.location.protocol && !(!br && !gr);
      },
      _i = hi,
      mi =
        Object.assign ||
      ...
      yi = function e(t) {
        ...
        V(this, e),
          ...
          (this.canMakePayment = function() {
            if (!_i()) return Ie.resolve(!1);
            if (!n._frame) throw new Error('Frame not initialized.');
            var e = n._frame;
            return fi(function() {
              return e.action(no.CAN_MAKE_PAYMENT).then(function(e) {
            ...
            n._frame &&
              (n._frame.send({
                ...
                payload: {
                  data: {
                    usesButtonElement:
                      n._usesButtonElement && n._usesButtonElement()
                  }
                }
              }),
              n._backdrop.mount(),
        ...
        return null !== gi
          ...
          ? t && 'https:' !== window.location.protocol
            ? (window.console &&
              ...
              Ie.resolve(!1))
            : e
            ? e.action(no.CAN_MAKE_PAYMENT).then(function(e) {
                var t = e.available;
                return (gi = !0 === t);
              })
            : Ie.resolve(!1)
      ...
      ki = (function(e) {
        function t(e, n, r, o) {
          $(this, t);
          var i = J(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
          Oi.call(i),
            (i._showCalledByButtonElement = null),
            (i._authentication = n),
            (i._controller = e),
            (i._mids = r),
            i._legacyReport('payreq.options', { options: o }),
            (i._cachedCanMakePayment = null),
            (i._canMakePaymentCalled = !1);
          var a = At(ho, o || {}, 'paymentRequest()'),
            s = a.value;
          if (
            (a.warnings.forEach(function(e) {
              return i._warn(e);
            }),
            bi && 'https:' === window.location.protocol)
          ) {
            i._controller.action.fetchLocale({ locale: 'auto' });
            var c = i._controller.createHiddenFrame(
              qt.PAYMENT_REQUEST_BROWSER,
              { authentication: n, mids: i._mids }
            );
            i._setupPrFrame(c, s), (i._prFrame = c);
      ...
      Oi = function() {
        ...
        (this._onEvent = null),
          ...
          (this.canMakePayment = pn(function() {
            return null === e._cachedCanMakePayment
              ? wi(e._prFrame, Ke(e._authentication.apiKey) === Ve.test).then(
                  function(t) {
                    return (
                      (e._canMakePaymentCalled = !0),
                      (e._cachedCanMakePayment = t),
          ...
          (this.update = pn(function(t) {
            var n = e._prFrame;
            if (n) {
              var r = At(_o, t, 'PaymentRequest update()'),
                o = r.value;
              r.warnings.forEach(function(t) {
                return e._warn(t);
              }),
          ...
          (this._setupPrFrame = function(t, n) {
            t.send({ action: 'stripe-pr-initialize', payload: { data: n } }),
              t._on('pr-cancel', function() {
                e._onEvent ? e._onEvent({ type: 'cancel' }) : e._emit('cancel');
              }),
              ...
              t._on('pr-callback', function(r) {
                ...
                if ('token' === o) {
                  ...
                  if (
                    ...
                    throw new Error(
                      'Unexpected event from PaymentRequest inner: ' + o
                    );
                  if (e._hasRegisteredListener(o) || e._onEvent) {
                    var c = a.shippingAddress,
                      u = a.shippingOption,
                      l = function(r) {
                        var a = At(yo, r || {}, o + ' callback'),
                          s = a.value;
                        a.warnings.forEach(function(t) {
                          ...
                          'shippingaddresschange' === o &&
                            s.status === ao.success &&
                            ri(s.shippingOptions || n.shippingOptions),
                          t.send({
                            action: 'stripe-pr-callback-complete',
                    ...
                    if ('shippingaddresschange' === o) {
                      var p = { shippingAddress: c, updateWith: l };
                      e._onEvent
                        ? e._onEvent({
                            type: 'shippingaddresschange',
                            payload: p
                      ...
                      var d = { shippingOption: u, updateWith: l };
                      e._onEvent
                        ? e._onEvent({
                            type: 'shippingoptionchange',
                            payload: d
                    ...
                    'shippingaddresschange' === o && ri(n.shippingOptions),
                      t.send({
                        action: 'stripe-pr-callback-complete',
                        payload: { nonce: i, data: { status: ao.success } }
                      });
                }
              });
          }),
          (this._handleToken = function(t, n, r) {
            ...
            if (e._onEvent)
              return void e._onEvent({
                type: 'paymentresponse',
                payload: Ei({}, i, {
                  __googlePayBillingAddress: o && o.address,
                  complete: r
                })
              });
            e._hasRegisteredListener('token') &&
              e._emit('token', Ei({}, i, { complete: r }));
            var a = i.token,
              s = K(i, ['token']),
              c = n.payerPhone || null,
              u = n.payerEmail || null,
              l = e._showCalledByButtonElement ? xt.paymentRequestButton : null;
            e._hasRegisteredListener('source') &&
              e._controller.action
                .createSourceWithData({
                  elementName: l,
                ...
                .then(function(t) {
                  'error' === t.type
                    ...
                    : e._emit(
                        'source',
                        Ei({}, s, { source: t.object, complete: r })
                      );
                }),
              e._hasRegisteredListener('paymentmethod') &&
                e._controller.action
                  .createPaymentMethodWithData({
                    ...
                    paymentMethodData: {
                      card: { token: a.id },
                      billing_details: Ei({ phone: c, email: u }, o || {})
                    },
                    mids: null
                  })
                  .then(function(t) {
                    'error' === t.type
                      ...
                      : e._emit(
                          'paymentmethod',
                          Ei({}, s, { paymentMethod: t.object, complete: r })
                        );
                  });
          });
      },
      ...
      Ai = (function(e) {
        function t(e) {
          ...
          var r = At(ho, e.rawOptions || {}, 'paymentRequest()'),
            o = r.value;
          if (
          ...
          return (
            (n._initialOptions = o),
            (n._queryStrategy = e.queryStrategyOverride || ko(e.betas)),
      ...
      Ci = function() {
        ...
        (this._usedByButtonElement = null),
          ...
          (this._registerElement = function() {
            (e._usedByButtonElement = !0),
              e._backingLibraries.APPLE_PAY &&
                e._backingLibraries.APPLE_PAY._registerElement(),
              e._backingLibraries.BROWSER &&
                e._backingLibraries.BROWSER._registerElement();
          }),
          (this._elementShow = function() {
            (e._showCalledByButtonElement = !0),
              e._backingLibraries.APPLE_PAY &&
                (e._backingLibraries.APPLE_PAY._showCalledByButtonElement = !0),
              e._backingLibraries.BROWSER &&
                (e._backingLibraries.BROWSER._showCalledByButtonElement = !0),
              e.show();
          }),
                ...
                case 'APPLE_PAY':
                  var r = new li(
                    Si(
                      ...
                      t.__minApplePayVersion
                        ? { minimumVersion: t.__minApplePayVersion }
                        : {}
                    )
                  );
                  r.setEventHandler(e._handleInternalEvent),
                    (e._backingLibraries.APPLE_PAY = r);
                  break;
                case 'GOOGLE_PAY':
                  var o = new vi({
                    controller: e._controller,
                  ...
                  o.setEventHandler(e._handleInternalEvent),
                    (e._backingLibraries.GOOGLE_PAY = o);
                  break;
                case 'BROWSER':
                  var i = new Pi(
                    e._controller,
                  ...
                  i.setEventHandler(e._handleInternalEvent),
                    (e._backingLibraries.BROWSER = i);
                  break;
                default:
                  Ce(n);
              }
              ...
              case 'paymentmethod':
                var c = t.type,
                  ...
                  f = function(t) {
                    ...
                    var n = At(vo, t, 'status for PaymentRequest completion'),
                      r = n.value;
                    n.warnings.forEach(function(t) {
                      return e._controller.warn(t);
                    }),
          ...
          (this._emitPaymentResponse = function(t) {
            ...
            var n = t.__googlePayBillingAddress,
              r = X(t, ['__googlePayBillingAddress']),
              o = r.token,
              i = X(r, ['token']),
              a = i.payerEmail,
              s = i.payerPhone,
              c = i.complete,
              u = e._showCalledByButtonElement ? xt.paymentRequestButton : null;
            e._hasRegisteredListener('token') &&
                ...
                e._controller.action
                  ...
                  .then(function(t) {
                    'error' === t.type
                      ...
                      : e._maybeEmitPaymentResponse({
                          type: 'paymentmethod',
                          payload: Si({}, i, { paymentMethod: t.object })
                        });
                  });
          }),
          (this._canMakePaymentForBackingLibrary = function(t) {
            ...
            return Ie.race([
              ...
              return (
                (e._canMakePaymentAvailability = Si(
                  {},
          ...
          (this.canMakePayment = pn(function() {
            ...
            if ('https:' !== window.location.protocol)
              return (e._canMakePaymentResolved = !0), Ie.resolve(null);
          ...
          (this.show = pn(function() {
            ...
            if (!e._activeBackingLibrary)
              ...
              new Ae('Payment Request is not available in this browser.'));
      ...
      ji = {
        classes: rt(
          Pt({
            ...
            focus: rt(pt),
            invalid: rt(pt),
            webkitAutofill: rt(pt)
          })
        ),
        hidePostalCode: rt(ft),
        hideIcon: rt(ft),
        style: rt(Pt(Ri)),
        iconStyle: rt(st('solid', 'default')),
        value: rt(ot(pt, bt)),
        __privateCvcOptional: rt(ft),
        __privateValue: rt(ot(pt, bt)),
        __privateEmitIbanValue: rt(ft),
        error: rt(
          Pt({ type: pt, code: rt(pt), decline_code: rt(pt), param: rt(pt) })
        ),
        locale: Et('elements()'),
        fonts: Et('elements()'),
        placeholder: rt(pt),
        disabled: rt(ft),
        placeholderCountry: rt(pt),
        paymentRequest: rt(
          (function(e, t) {
            return function(n, r) {
              return n instanceof e ? Xe(n) : nt('a ' + t + ' instance', n, r);
            };
          })(Ti, 'stripe.paymentRequest(...)')
        ),
        supportedCountries: rt(gt(pt))
      },
      Ii = Pt(ji),
      Mi = function(e, t) {
        if (!(e && e in Er))
        ...
        if (Er[e].unique && -1 !== t.indexOf(e))
          throw new Ae('Can only create one Element of type ' + e + '.');
        var n = Ue(t, Er[e].conflict);
        if (n.length) {
          var r = n[0];
          throw new Ae(
      ...
      Ni = function() {
        var e =
            arguments.length > 0 && void 0 !== arguments[0]
              ...
              : '1.2em',
          t =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : qi,
          n =
              ...
              value: function(e) {
                ...
                if ('paymentRequestButton' === this._componentName) {
                  ...
                  if (
                    ...
                    var d =
                        -1 === Gt.indexOf(this._componentName)
                          ? void 0
                          : p || this._lastPadding,
                      f = Di(u || this._lastHeight, l || this._lastFontSize, d);
            ...
            },
            {
              ...
              value: function(e, t) {
                var n = this,
                  ...
                  e.controller,
                  e.paymentRequest,
                  re(e, ['classes', 'controller', 'paymentRequest'])),
      ...
      Qi = { locale: rt(pt), fonts: rt(gt(bt)) },
      Zi = Pt(Qi),
      Xi = function e(t, n) {
        var r = this;
        ue(this, e), ea.call(this);
        var o = At(Zi, n || {}, 'elements()'),
          i = o.value;
        ...
        var c = s
          ...
          u = s
            ...
            .map(function(e) {
              return Tt(e) ? e : It(window.location.href, e);
            });
        return (
      ...
      ea = function() {
        var e = this;
        this.create = dn(function(t, n) {
          Mi(t, e._elements);
          var r = At(Ii, n || {}, 'create()'),
            o = r.value;
          r.warnings.forEach(function(t) {
            return e._controller.warn(t);
          });
          ...
          return (
            (e._elements = [].concat(ce(e._elements), [t])),
      ...
      aa = function(e, t) {
        switch (e.type) {
          ...
          case 'error':
            return { error: ia({}, t ? { payment_intent: t } : {}, e.error) };
          default:
            return Ce(e);
        }
      },
      ...
      ca = function(e, t) {
        if ('string' != typeof e) return nt('a client_secret string', e, t);
        var n = sa(e);
        return null === n
          ? nt('a client secret of the form ${id}_secret_${secret}', e, t)
          : Xe(n, []);
      },
      ua = function(e, t) {
        if (null == e) return Xe(null);
        var n = e.type,
          r = pe(e, ['type']),
          o = ia({}, t, { path: [].concat(le(t.path), ['type']) }),
          i = dt(pt, function() {
            return null;
          })(n, o);
        return 'error' === i.type ? i : Xe({ type: i.value, data: r });
      },
      la = function(e) {
      ...
      da = function(e, t) {
        if (null === e) return tt('object', 'null', t);
        if ('object' !== (void 0 === e ? 'undefined' : oa(e)))
          return tt('object', void 0 === e ? 'undefined' : oa(e), t);
        var n = e.client_secret,
          r = e.status,
          o = e.next_action,
          i = ia({}, t, { path: [].concat(le(t.path), ['client_secret']) }),
          a = ca(n, i);
        if ('error' === a.type) return a;
        if ('string' != typeof r) {
          var s = ia({}, t, { path: [].concat(le(t.path), ['status']) });
          return tt('string', void 0 === r ? 'undefined' : oa(r), s);
        }
        if (
          ('requires_source_action' === r || 'requires_action' === r) &&
          'object' !== (void 0 === o ? 'undefined' : oa(o))
        ) {
          var c = ia({}, t, { path: [].concat(le(t.path), ['next_action']) });
          return tt('object', void 0 === o ? 'undefined' : oa(o), c);
        }
        return Xe(e, []);
      },
      fa = function(e) {
        return function(t, n) {
          if ('object' === (void 0 === t ? 'undefined' : oa(t)) && null !== t) {
            var r = t.source,
              o = t.source_data,
              i = t.payment_method,
            ...
            if (null != r && 'string' != typeof r) {
              var c = ia({}, n, { path: [].concat(le(n.path), ['source']) });
              return tt('string', void 0 === r ? 'undefined' : oa(r), c);
            }
            if (null != i && 'string' != typeof i) {
              var u = ia({}, n, {
                path: [].concat(le(n.path), ['payment_method'])
              });
              return tt('string', void 0 === i ? 'undefined' : oa(i), u);
            }
            if (
              null != o &&
              'object' !== (void 0 === o ? 'undefined' : oa(o))
              ...
              var l = ia({}, n, {
                path: [].concat(le(n.path), ['source_data'])
              });
              return tt('object', void 0 === o ? 'undefined' : oa(o), l);
            }
            if (
              null != a &&
              'object' !== (void 0 === a ? 'undefined' : oa(a))
            ) {
              var p = ia({}, n, {
                path: [].concat(le(n.path), ['payment_method_data'])
              });
              return tt('object', void 0 === a ? 'undefined' : oa(a), p);
            }
            var d = ia({}, n, { path: [].concat(le(n.path), ['source_data']) }),
              f = ua(o, d);
          ...
          return null === t
            ? tt('object', 'null', n)
            : tt('object', void 0 === t ? 'undefined' : oa(t), n);
        };
      },
      ha = function(e) {
        return function(t, n) {
          ...
          if ('object' !== (void 0 === t ? 'undefined' : oa(t)))
            return tt('object', void 0 === t ? 'undefined' : oa(t), n);
          if (null === t) return tt('object', 'null', n);
          if (e) {
            if (!t.payment_intent)
              return Xe({
                sourceData: null,
            ...
            var r = t.payment_intent,
              ...
              i = ia({}, n, {
                path: [].concat(le(n.path), ['payment_intent'])
              });
            return fa(o)(r, i);
          }
      ...
      ma = ((Pe = {}),
      de(Pe, xt.card, _a.card),
      de(Pe, xt.cardNumber, _a.card),
      de(Pe, xt.cardExpiry, _a.card),
      de(Pe, xt.cardCvc, _a.card),
      de(Pe, xt.postalCode, _a.card),
      de(Pe, xt.iban, _a.sepa_debit),
      de(Pe, xt.idealBank, _a.ideal),
      Pe),
      ya = function(e) {
      ...
      Ea = '__privateStripeMetricsController',
      ka = { MERCHANT: 'merchant', SESSION: 'session' },
      Oa = (function() {
        function e() {
          var t = this,
            n =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : {};
          if ((fe(this, e), n.checkoutIds)) {
            var r = n.checkoutIds,
              o = r.muid,
              i = r.sid;
            (this._muid = o), (this._sid = i), (this._doNotPersist = !0);
          } else
            (this._muid = this._getID(ka.MERCHANT)),
              (this._sid = this._getID(ka.SESSION)),
              (this._doNotPersist = !1);
          (this._id = Kt(Ea)),
            (this._controllerFrame = new Cn(qt.METRICS_CONTROLLER, this._id, {
              autoload: !0,
              queryString: this._buildFrameQueryString()
            })),
            (this._guidPromise = new Ie(function(e) {
        ...
        return (
          wa(e, [
                ...
                setInterval(function() {
                  ...
                  n !== t &&
                    (e.send({
                      action: 'ping',
                      payload: {
                        sid: e._getID(ka.SESSION),
                        muid: e._getID(ka.MERCHANT),
              ...
              value: function(e, t) {
                try {
                  this.send({
                    action: 'track',
                    payload: {
                      sid: this._getID(ka.SESSION),
                      muid: this._getID(ka.MERCHANT),
                      url: document.location.href,
                      source: e,
                      data: t
                    }
            ...
            },
            {
              key: 'send',
              value: function(e) {
                var t = Dt(qt.METRICS_CONTROLLER);
                nr(t) && this._controllerFrame.send(e);
              }
            },
            {
              key: '_testLatency',
      ...
      Pa = Oa,
      Sa = { _frame: Pt({ id: pt }), _componentName: pt },
      Aa = Pt(Sa),
      Ca = function(e) {
        var t = St(Aa, e, '');
      ...
      ja = function(e, t, n, r, o, i) {
        ...
        var s = a.value,
          ...
          h = u.otherParams;
        if (!e && l)
          throw new Ae(r + ': Expected payment_method_data, not source_data.');
        if (null != p)
          throw new Ae(
            'When calling ' +
              r +
      ...
      qa = function(e, t, n) {
        return e.createLightboxFrame(qt.AUTHORIZE_WITH_URL, {
          url: t,
          locale: n
        });
      },
      ...
      Ba = function(e) {
        if (!e || 'object' !== (void 0 === e ? 'undefined' : Da(e)))
          return null;
        var t = e.type,
          n = he(e, ['type']);
      ...
      Fa = {
        source: Pt({ id: at('src_'), client_secret: at('src_client_secret_') })
      },
      Ua = Pt(Fa),
      za = function(e) {
        switch (e.type) {
      ...
      Va = function(e, t, n) {
        return e.createLightboxFrame(qt.CARDINAL_3DS2, {
          intentSecret: t,
          locale: n
        });
      },
      Ka = function(e, t, n) {
        return e.createLightboxFrame(qt.STRIPE_3DS2, {
          intentSecret: t,
          locale: n
        });
      },
      $a = function(e) {
        return function(t) {
          ...
          new Ae('Malformed frame action response'));
        };
      },
      Ja = function(e, t, n, r) {
        var o = Date.now(),
          ...
          new Ie(function(r) {
            i._on('load', function() {
              n.report('3ds2.frame.loaded', { loadDuration: Date.now() - o }),
                i.fadeInBackdrop(),
                i
                  .action('3ds2-init', Ga({}, t, { clientSecret: e }))
                  .then(Qa(n))
                  .then(aa)
                  .then(function(e) {
                    n.report('3ds2.done', {
      ...
      Xa = function(e, t, n) {
        var r = function(t) {
          return Ha(n, 'ideal redirect', t), aa(t, e);
        };
        return Wa(t).then(r);
      },
      es = function(e) {
      ...
      ts = function(e, t, n, r) {
        var o = Na(pa(t), n);
        if (!o) return Ie.resolve({ paymentIntent: t });
        switch (o.type) {
          case '3ds1-modal':
            return La(o.url, e, r).then(function(e) {
          ...
          case 'ideal-redirect':
            return Xa(t, o.redirectUrl, e);
          default:
            return Ie.resolve({ paymentIntent: t });
        }
      },
      ns = function(e, t, n) {
        return function(r) {
          ...
          switch (o.type) {
            case 'error':
              ...
              return n &&
                ...
                ? Ie.resolve({ paymentIntent: a })
                : Ie.resolve(aa(r));
            case 'object':
              var s = o.object;
              return ts(e, s, t, o.locale);
            default:
              return Ce(o);
          }
        };
      ...
      os = function(e, t) {
        var n = At(ca, e, 'retrievePaymentIntent'),
          r = n.value;
        return t.action.retrievePaymentIntent(r).then(aa);
      },
      is = function(e, t, n, r, o, i) {
        var a = At(ca, r, 'stripe.confirmPaymentIntent intent secret'),
          s = a.value,
          c = Ma(e, !1, null, 'confirmPaymentIntent')(o, i);
        return t.action
          .confirmPaymentIntent(
            Ga({}, c, { intentSecret: s, expectedType: null, mids: n })
          )
          .then(aa);
      },
      as = function(e, t) {
        var n = At(ca, e, 'handleCardAction'),
          r = n.value;
        return t.action.retrievePaymentIntent(r).then(function(e) {
          var n = es(e);
          switch (n.type) {
            case 'error':
              return Ie.resolve(aa(e));
            case 'object':
              var r = n.object;
              if (la(r.status)) {
                ...
                return ts(t, r, _a.card, n.locale);
              }
              throw new Ae(
      ...
      ss = function(e, t, n, r, o, i, a) {
        var s = At(ca, o, 'stripe.handleCardPayment intent secret'),
          c = s.value,
          u = _a.card,
          l = Ma(e, r, u, 'handleCardPayment')(i, a),
          p = !i && !a;
        return t.action
          .confirmPaymentIntent(
            Ga({}, l, {
              otherParams: Ga({}, l.otherParams, { use_stripe_sdk: !0 }),
              intentSecret: c,
              expectedType: u,
              mids: n
            })
      ...
      cs = function(e, t, n, r, o, i) {
        var a = At(ca, r, 'stripe.handleSepaDebitPayment intent secret'),
          s = a.value,
          c = _a.sepa_debit,
          u = Ma(!0, n, c, 'handleSepaDebitPayment')(o, i),
          l = !o && !i;
        return e.action
          .confirmPaymentIntent(
            Ga({}, u, { intentSecret: s, expectedType: c, mids: t })
          )
          .then(ns(e, c, l));
      },
      us = function(e, t, n, r, o, i) {
        var a = At(ca, r, 'stripe.handleIdealPayment intent secret'),
          s = a.value,
          c = _a.ideal,
          u = Ma(!0, n, c, 'handleIdealPayment')(o, i),
          l = !o && !i;
        return e.action
          .confirmPaymentIntent(
            Ga({}, u, { intentSecret: s, expectedType: c, mids: t })
      ...
      ps = function(e, t, n, r) {
        var o = Na(pa(t), n);
        if (!o) return Ie.resolve({ setupIntent: t });
        switch (o.type) {
          case '3ds1-modal':
            return La(o.url, e, r).then(function(e) {
              if (e.setupIntent || e.error) return e;
              throw new Error(
                'Got PaymentIntent response from AuthorizeWithUrl'
              );
            });
          default:
            return Ie.resolve({ setupIntent: t });
        }
      },
      ds = function(e) {
        switch (e.type) {
          ...
          switch (r.type) {
            case 'error':
              ...
              return n && i && 'succeeded' === i.status
                ? Ie.resolve({ setupIntent: i })
                : Ie.resolve({ error: o });
            case 'object':
              var a = r.object;
              return ps(e, a, t, r.locale);
            default:
              return Ce(r);
          }
        };
      ...
      hs = function(e, t, n, r, o) {
        var i = At(ca, n, 'stripe.handleCardSetup intent secret'),
          a = i.value,
          s = _a.card,
          c = Ma(!1, !1, s, 'handleCardSetup')(r, o),
          u = !r && !o;
        return e.action
          .confirmSetupIntent(
            ls({}, c, {
              otherParams: ls({}, c.otherParams, { use_stripe_sdk: !0 }),
              intentSecret: a,
              expectedType: s,
              mids: t
            })
      ...
      _s = function(e, t) {
        var n = At(ca, e, 'stripe.retrieveSetupIntent intent secret'),
          r = n.value;
        return t.action.retrieveSetupIntent(r).then(ds);
      },
      ms = function(e, t, n, r, o) {
        var i = At(ca, n, 'stripe.confirmSetupIntent intent secret'),
          a = i.value,
          s = Ma(!1, !1, null, 'confirmSetupIntent')(r, o);
        return e.action
          .confirmSetupIntent(
            ls({}, s, {
              otherParams: ls({}, s.otherParams),
              intentSecret: a,
              expectedType: null,
              mids: t
            })
      ...
      ys = [bo.checkout_beta_2, bo.checkout_beta_3, bo.checkout_beta_4],
      vs = [
        bo.checkout_beta_2,
        bo.checkout_beta_3,
        bo.checkout_beta_4,
        bo.checkout_pm_types
      ],
      bs = {
        da: 'da',
        de: 'de',
      ...
      Es = {
        sku: rt(pt),
        plan: rt(pt),
        clientReferenceId: rt(pt),
        locale: rt(st.apply(void 0, ['auto'].concat(me(gs)))),
        customerEmail: rt(pt),
        billingAddressCollection: rt(st('required', 'auto')),
        submitType: rt(st('auto', 'pay', 'book', 'donate')),
        paymentMethodTypes: rt(gt(st('card', 'ideal')))
      },
      ks = function(e, t, n) {
        if ((e && t) || ((e || t) && n))
          throw new Ae(
      ...
      Os = function(e) {
        var t = Ot(
            ws({}, Es, {
              items: rt(
                ot(
                  gt(Ot({ type: st('plan'), quantity: _t(0), id: pt })),
                  gt(Ot({ type: st('sku'), quantity: _t(0), id: pt }))
                )
              ),
              successUrl: pt,
              cancelUrl: pt
          ...
          n = At(t, e, 'stripe.redirectToCheckout'),
          r = n.value,
          o = r.sku,
          i = r.plan,
          a = r.items,
          s = _e(r, ['sku', 'plan', 'items']),
          c = ks(o, i, a);
        return ws({ tag: 'no-session', items: c }, s);
      },
      Ps = function(e, t) {
        var n = Ot(
            ws({}, Es, {
              ...
              items: rt(
                ot(
                  gt(Ot({ quantity: _t(0), plan: pt })),
                  gt(Ot({ quantity: _t(0), sku: pt }))
                )
              )
            })
          ),
          r = At(n, e, 'stripe.redirectToCheckout'),
          o = r.value;
        if (o.sessionId) {
          var i = o.sessionId;
      ...
      Cs = function(e, t) {
        return 'session' === t.tag ||
          null == e ||
          t.locale ||
          -1 === ['auto'].concat(me(gs)).indexOf(e)
          ? t
          : ws({}, t, { locale: e });
      },
      Ts = function(e, t, n) {
        var r = Le(ys, function(t) {
          return wo(e, t);
        });
        switch ((As(r, e, t), r)) {
      ...
      Ms = function(e, t) {
        var n = function(t) {
          return Ha(e, 'redirectToCheckout', t), { error: t.error };
        };
        return Wa(t).then(n);
      },
      qs = function(e, t, n, r) {
      ...
      Bs = function(e, t, n) {
        ...
        if (r && 'cardCvc' === r._componentName) {
          var o = r._frame.id;
          return e.action.tokenizeCvcUpdate({ frameId: o, mids: n }).then(Ns);
        }
        throw new Ae(
      ...
      zs = Pt({
        ...
        stripeAccount: rt(pt),
        locale: rt(pt),
        __privateApiUrl: rt(pt),
        __checkout: rt(Pt({ mids: Pt({ muid: pt, sid: pt }) })),
        betas: rt(gt(ct.apply(void 0, be(go))))
      }),
      Ws = function(e) {
        return (
      ...
      Hs = (function() {
        function e(t, n) {
          var r = this;
          ve(this, e), Ys.call(this);
          var o = At(zs, t || {}, 'Stripe()'),
            i = o.value,
            a = o.warnings,
            s = i.apiKey,
            c = i.stripeAccount,
          ...
          p && p.mids && (e._ec = new Pa({ checkoutIds: p.mids })),
            (this._apiKey = s),
            (this._keyMode = Ke(s)),
            (this._locale = u || null),
            (this._betas = d || []),
          ...
          Us(e, [
            {
              ...
              value: function(e) {
                var t = this,
                  n =
                    wo(this._betas, bo.payment_intent_beta_1) ||
                    wo(this._betas, bo.payment_intent_beta_2),
                  r = function() {
                    return t._mids();
                  },
                  o = fn(function() {
                  ...
                  p = qn(as, Ws('handleCardAction')),
                  d = pn(function(e) {
                    return p(e, t._controller);
                  }),
                  f = qn(hs, Ws('handleCardSetup')),
                  h = fn(function() {
                    for (
                      var e = arguments.length, n = Array(e), o = 0;
                      o < e;
                  ...
                  m = fn(function() {
                    for (
                      ...
                      n[o] = arguments[o];
                    return ms.apply(void 0, [t._controller, r()].concat(n));
                  }),
                  y = fn(function() {
                    for (
                      var e = arguments.length, o = Array(e), i = 0;
                ...
                (this.createPaymentMethod = o),
                  ...
                  (this.handleCardSetup = h),
                  (this.retrieveSetupIntent = _),
                  (this.confirmSetupIntent = m);
                var b = function(e) {
                  return function() {
                    throw new Ae(
                ...
                (this.fulfillPaymentIntent = b('fulfillPaymentIntent')),
                  (this.handleSepaDebitPayment = b('handleSepaDebitPayment')),
                  (this.handleIdealPayment = b('handleIdealPayment')),
                  wo(this._betas, bo.payment_intent_beta_1)
                    ? (this.fulfillPaymentIntent = u)
                    : (wo(this._betas, bo.payment_intent_beta_3) ||
                        wo(this._betas, bo.payment_intent_beta_2)) &&
                      (this.handleCardPayment = u),
                  wo(this._betas, bo.payment_intent_beta_3) &&
                    ((this.confirmPaymentIntent = a),
                    (this.handleSepaDebitPayment = y),
                    (this.handleIdealPayment = v));
              }
            },
            {
              ...
              value: function(e) {
                var t = this;
                e &&
                  (this.tryNextSourceAction = dn(function(e, n) {
                    var r = At(da, e, 'Payment Intent'),
                      o = r.value,
                      i = Object.keys(_a).map(function(e) {
                        return _a[e];
                      }),
                      a = At(st.apply(void 0, be(i)), n, 'Source type'),
                      s = a.value;
                    return ts(t._controller, o, s, 'auto');
                  }));
              }
            },
            {
              ...
              value: function(e) {
                var t = this,
                  ...
                  r = e.reduce(function(e, t) {
                    var n = Le(vs, function(e) {
                      return e === t;
                    });
                    return n ? [].concat(be(e), [n]) : e;
                  }, []);
                this.redirectToCheckout = qs(
                  this._controller,
                  r,
                  n,
                  this._locale
            ...
            },
            {
              ...
              value: function() {
                ...
                if (
                  _r &&
                  !e &&
                  !wo(this._betas, bo.acknowledge_ie9_deprecation)
                )
                  throw (window.console && console.error(t), new Ae(t));
              }
            },
            {
              key: '_ensureHTTPS',
    ...
    var Ys = function() {
        var e = this;
        (this.elements = pn(function(t) {
          return new ta(
            e._controller,
            Fs({}, e._locale ? { locale: e._locale } : {}, t)
          );
        })),
          (this.createToken = dn(function(t, n) {
            var r = e._mids();
            if ('cvc_update' === t) {
              if (wo(e._betas, bo.cvc_update_beta_1))
                return Bs(e._controller, n, r);
              throw new Ae(
                "You cannot create a 'cvc_update' token without using the 'cvc_update_beta_1' beta flag."
              );
            }
            return xs(e._controller, r)(t, n);
          })),
          (this.createSource = dn(function(t, n) {
            var r = Ca(t),
              o = Ba(r ? n : t),
              i = o || { type: null, data: {} },
              a = i.type,
            ...
            return o
              ? a
                ? e._controller.action
                    ...
                    .then(xa)
                : Ie.reject(
                    new Ae('Please provide a source type to createSource.')
                  )
              : Ie.reject(
                  new Ae(
          ...
          (this.retrieveSource = pn(function(t) {
            var n = At(Ua, { source: t }, 'retrieveSource'),
              r = n.value;
            return (
              n.warnings.forEach(function(t) {
                return e._controller.warn(t);
              }),
              e._controller.action.retrieveSource(r).then(xa)
            );
          })),
          (this.paymentRequest = dn(function(t, n) {
            $e(e._keyMode);
      ...
      $s = (function() {
        if (document.currentScript) {
          var e = Rt(document.currentScript.src);
      ...
      Js = function(e, t) {
        return new Gs(
          Ks(
            { apiKey: e },
            t && 'object' === (void 0 === t ? 'undefined' : Vs(t)) ? t : {}
          ),
          $s
        );
      };
    (Js.version = Gs.version),
      window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3
        ? (window.Stripe.StripeV3 = Js)
        : window.Stripe
        ? window.console &&
          console.warn(
